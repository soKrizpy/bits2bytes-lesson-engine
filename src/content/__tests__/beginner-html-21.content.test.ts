// src/content/__tests__/beginner-html-21.content.test.ts
// Content-level tests for the beginner-html-21 lesson JSON.
...
import lessonData from '../../../public/lessons/beginner/html/beginner-html-21.json';
...
describe('Lesson metadata and structure', () => {
  it('metadata.id === "beginner-html-21"', () => {
    expect(lesson.metadata.id).toBe('beginner-html-21');
  });
  ...
  it('metadata.topicNumber === 4', () => {
    expect(lesson.metadata.topicNumber).toBe(4);
  });
