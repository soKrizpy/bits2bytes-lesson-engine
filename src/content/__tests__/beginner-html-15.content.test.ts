// src/content/__tests__/beginner-html-15.content.test.ts
// Content-level tests for the beginner-html-15 lesson JSON.
...
import lessonData from '../../../public/lessons/beginner/html/beginner-html-15.json';
...
describe('Lesson metadata and structure', () => {
  it('metadata.id === "beginner-html-15"', () => {
    expect(lesson.metadata.id).toBe('beginner-html-15');
  });
