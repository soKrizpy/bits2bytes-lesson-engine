// src/content/__tests__/beginner-html-02.content.test.ts
// Content-level tests for the beginner-html-02 lesson JSON.
...
import lessonData from '../../../public/lessons/beginner/html/beginner-html-02.json';
...
describe('Lesson metadata and structure', () => {
  it('metadata.id === "beginner-html-02"', () => {
    expect(lesson.metadata.id).toBe('beginner-html-02');
  });
