// src/content/__tests__/beginner-html-09.content.test.ts
// Content-level tests for the beginner-html-09 lesson JSON.
...
import lessonData from '../../../public/lessons/beginner/html/beginner-html-09.json';
...
describe('Lesson metadata and structure', () => {
  it('metadata.id === "beginner-html-09"', () => {
    expect(lesson.metadata.id).toBe('beginner-html-09');
  });
  ...
  it('metadata.topicNumber === 9', () => {
    expect(lesson.metadata.topicNumber).toBe(9);
  });
