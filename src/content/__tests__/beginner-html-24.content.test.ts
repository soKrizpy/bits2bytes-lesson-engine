// src/content/__tests__/beginner-html-24.content.test.ts
// Content-level tests for the beginner-html-24 lesson JSON.
...
import lessonData from '../../../public/lessons/beginner/html/beginner-html-24.json';
...
describe('Lesson metadata and structure', () => {
  it('metadata.id === "beginner-html-24"', () => {
    expect(lesson.metadata.id).toBe('beginner-html-24');
  });
  ...
  it('metadata.category === "JavaScript"', () => {
    expect(lesson.metadata.category).toBe('JavaScript');
  });

  it('metadata.topicNumber === 7', () => {
    expect(lesson.metadata.topicNumber).toBe(7);
  });
  ...
  it('metadata.estimatedTime === 45', () => {
    expect(lesson.metadata.estimatedTime).toBe(45);
  });
