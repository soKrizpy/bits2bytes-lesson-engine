// src/content/__tests__/beginner-html-16.content.test.ts
// Content-level tests for the beginner-html-16 lesson JSON.
...
import lessonData from '../../../public/lessons/beginner/html/beginner-html-16.json';
...
describe('Lesson metadata and structure', () => {
  it('metadata.id === "beginner-html-16"', () => {
    expect(lesson.metadata.id).toBe('beginner-html-16');
  });
