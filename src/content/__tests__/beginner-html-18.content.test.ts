// src/content/__tests__/beginner-html-18.content.test.ts
// Content-level tests for the beginner-html-18 lesson JSON.
...
import lessonData from '../../../public/lessons/beginner/html/beginner-html-18.json';
...
describe('Lesson metadata and structure', () => {
  it('metadata.id === "beginner-html-18"', () => {
    expect(lesson.metadata.id).toBe('beginner-html-18');
  });
  ...
  it('metadata.topicNumber === 1', () => {
    expect(lesson.metadata.topicNumber).toBe(1);
  });
