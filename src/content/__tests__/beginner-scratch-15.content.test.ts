// src/content/__tests__/beginner-scratch-15.content.test.ts
// Content-level tests for the beginner-scratch-15 lesson JSON.

import { describe, it, expect } from 'vitest';
import lessonData from '../../../public/lessons/beginner/scratch/beginner-scratch-15.json';
...
describe('Lesson metadata and structure', () => {
  it('metadata.id === "beginner-scratch-15"', () => {
    expect(lesson.metadata.id).toBe('beginner-scratch-15');
  });
