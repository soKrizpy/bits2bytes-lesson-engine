// src/content/__tests__/beginner-html-23.content.test.ts
// Content-level tests for the beginner-html-23 lesson JSON.
...
import lessonData from '../../../public/lessons/beginner/html/beginner-html-23.json';
...
describe('Lesson metadata and structure', () => {
  it('metadata.id === "beginner-html-23"', () => {
    expect(lesson.metadata.id).toBe('beginner-html-23');
  });
  ...
  it('metadata.topicNumber === 6', () => {
    expect(lesson.metadata.topicNumber).toBe(6);
  });
