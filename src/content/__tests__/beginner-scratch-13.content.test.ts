// src/content/__tests__/beginner-scratch-13.content.test.ts
// Content-level tests for the beginner-scratch-13 lesson JSON.

import { describe, it, expect } from 'vitest';
import lessonData from '../../../public/lessons/beginner/scratch/beginner-scratch-13.json';
...
describe('Lesson metadata and structure', () => {
  it('metadata.id === "beginner-scratch-13"', () => {
    expect(lesson.metadata.id).toBe('beginner-scratch-13');
  });
