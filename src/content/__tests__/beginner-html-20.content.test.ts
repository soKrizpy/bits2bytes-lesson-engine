// src/content/__tests__/beginner-html-20.content.test.ts
// Content-level tests for the beginner-html-20 lesson JSON.
...
import lessonData from '../../../public/lessons/beginner/html/beginner-html-20.json';
...
describe('Lesson metadata and structure', () => {
  it('metadata.id === "beginner-html-20"', () => {
    expect(lesson.metadata.id).toBe('beginner-html-20');
  });
