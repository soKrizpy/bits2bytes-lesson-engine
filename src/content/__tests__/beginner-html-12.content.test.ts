// src/content/__tests__/beginner-html-12.content.test.ts
// Content-level tests for the beginner-html-12 lesson JSON.
...
import lessonData from '../../../public/lessons/beginner/html/beginner-html-12.json';
...
describe('Lesson metadata and structure', () => {
  it('metadata.id === "beginner-html-12"', () => {
    expect(lesson.metadata.id).toBe('beginner-html-12');
  });
