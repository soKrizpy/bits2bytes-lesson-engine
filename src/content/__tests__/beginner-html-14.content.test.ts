// src/content/__tests__/beginner-html-14.content.test.ts
// Content-level tests for the beginner-html-14 lesson JSON.
...
import lessonData from '../../../public/lessons/beginner/html/beginner-html-14.json';
...
describe('Lesson metadata and structure', () => {
  it('metadata.id === "beginner-html-14"', () => {
    expect(lesson.metadata.id).toBe('beginner-html-14');
  });
