// src/content/__tests__/beginner-html-22.content.test.ts
// Content-level tests for the beginner-html-22 lesson JSON.
...
import lessonData from '../../../public/lessons/beginner/html/beginner-html-22.json';
...
describe('Lesson metadata and structure', () => {
  it('metadata.id === "beginner-html-22"', () => {
    expect(lesson.metadata.id).toBe('beginner-html-22');
  });
