// src/content/__tests__/beginner-html-10.content.test.ts
// Content-level tests for the beginner-html-10 lesson JSON.
...
import lessonData from '../../../public/lessons/beginner/html/beginner-html-10.json';
...
describe('Lesson metadata and structure', () => {
  it('metadata.id === "beginner-html-10"', () => {
    expect(lesson.metadata.id).toBe('beginner-html-10');
  });
  ...
  it('metadata.topicNumber === 10', () => {
    expect(lesson.metadata.topicNumber).toBe(10);
  });
