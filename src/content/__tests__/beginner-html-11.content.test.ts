// src/content/__tests__/beginner-html-11.content.test.ts
// Content-level tests for the beginner-html-11 lesson JSON.
...
import lessonData from '../../../public/lessons/beginner/html/beginner-html-11.json';
...
describe('Lesson metadata and structure', () => {
  it('metadata.id === "beginner-html-11"', () => {
    expect(lesson.metadata.id).toBe('beginner-html-11');
  });
