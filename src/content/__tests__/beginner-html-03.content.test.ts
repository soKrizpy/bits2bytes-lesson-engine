// src/content/__tests__/beginner-html-03.content.test.ts
// Content-level tests for the beginner-html-03 lesson JSON.
...
import lessonData from '../../../public/lessons/beginner/html/beginner-html-03.json';
...
describe('Lesson metadata and structure', () => {
  it('metadata.id === "beginner-html-03"', () => {
    expect(lesson.metadata.id).toBe('beginner-html-03');
  });
