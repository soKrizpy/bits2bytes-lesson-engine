// src/content/__tests__/beginner-html-04.content.test.ts
// Content-level tests for the beginner-html-04 lesson JSON.
...
import lessonData from '../../../public/lessons/beginner/html/beginner-html-04.json';
...
describe('Lesson metadata and structure', () => {
  it('metadata.id === "beginner-html-04"', () => {
    expect(lesson.metadata.id).toBe('beginner-html-04');
  });
