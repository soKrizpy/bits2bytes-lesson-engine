// src/content/__tests__/beginner-html-08.content.test.ts
// Content-level tests for the beginner-html-08 lesson JSON.
...
import lessonData from '../../../public/lessons/beginner/html/beginner-html-08.json';
...
describe('Lesson metadata and structure', () => {
  it('metadata.id === "beginner-html-08"', () => {
    expect(lesson.metadata.id).toBe('beginner-html-08');
  });
  ...
  it('metadata.topicNumber === 8', () => {
    expect(lesson.metadata.topicNumber).toBe(8);
  });
