// src/content/__tests__/beginner-html-06.content.test.ts
// Content-level tests for the beginner-html-06 lesson JSON.
...
import lessonData from '../../../public/lessons/beginner/html/beginner-html-06.json';
...
describe('Lesson metadata and structure', () => {
  it('metadata.id === "beginner-html-06"', () => {
    expect(lesson.metadata.id).toBe('beginner-html-06');
  });
