// src/content/__tests__/beginner-html-19.content.test.ts
// Content-level tests for the beginner-html-19 lesson JSON.
...
import lessonData from '../../../public/lessons/beginner/html/beginner-html-19.json';
...
describe('Lesson metadata and structure', () => {
  it('metadata.id === "beginner-html-19"', () => {
    expect(lesson.metadata.id).toBe('beginner-html-19');
  });
  ...
  it('metadata.topicNumber === 2', () => {
    expect(lesson.metadata.topicNumber).toBe(2);
  });
