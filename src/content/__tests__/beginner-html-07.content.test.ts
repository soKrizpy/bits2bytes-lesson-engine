// src/content/__tests__/beginner-html-07.content.test.ts
// Content-level tests for the beginner-html-07 lesson JSON.
...
import lessonData from '../../../public/lessons/beginner/html/beginner-html-07.json';
...
describe('Lesson metadata and structure', () => {
  it('metadata.id === "beginner-html-07"', () => {
    expect(lesson.metadata.id).toBe('beginner-html-07');
  });
