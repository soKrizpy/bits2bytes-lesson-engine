// src/content/__tests__/beginner-scratch-20.content.test.ts
// Content-level tests for the beginner-scratch-20 lesson JSON.

import { describe, it, expect } from 'vitest';
import lessonData from '../../../public/lessons/beginner/scratch/beginner-scratch-20.json';
...
describe('Lesson metadata and structure', () => {
  it('metadata.id === "beginner-scratch-20"', () => {
    expect(lesson.metadata.id).toBe('beginner-scratch-20');
  });
