// src/content/__tests__/beginner-html-17.content.test.ts
// Content-level tests for the beginner-html-17 lesson JSON.
...
import lessonData from '../../../public/lessons/beginner/html/beginner-html-17.json';
...
describe('Lesson metadata and structure', () => {
  it('metadata.id === "beginner-html-17"', () => {
    expect(lesson.metadata.id).toBe('beginner-html-17');
  });
