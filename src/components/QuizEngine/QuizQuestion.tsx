  ...
  return (
    <div className="space-y-4">
      ...
      {question.type === 'image-choice' ? (
        <div className="grid grid-cols-2 gap-4" role="radiogroup" aria-label={question.question}>
          {(question as ImageChoiceQuestion).imageOptions.map((opt) => {
            ...
            return (
              <button
                ...
                className={[
                  'w-full flex flex-col items-center justify-center p-4 rounded-xl border transition-all duration-300',
                  'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background',
                  isSelected
                    ? 'border-primary bg-primary/10 text-text-base ring-1 ring-primary/40'
              ...
              >
                ...
                {opt.label && <span className="text-center text-sm font-medium w-full truncate">{opt.label}</span>}
              </button>
            );
          })}
        </div>
